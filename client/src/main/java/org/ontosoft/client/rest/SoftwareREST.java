...
public class SoftwareREST {
	public static HashMap<String, SoftwareREST> singletons = new HashMap<String, SoftwareREST>();
	...
	private List<SoftwareVersionSummary> modelVersionList;
	...
	private HashMap<String, Software> softwareCache = new HashMap<String, Software>();
	private HashMap<String, Model> modelCache = new HashMap<String, Model>();
	private HashMap<String, SoftwareVersion> softwareVersionCache = new HashMap<String, SoftwareVersion>();
	private HashMap<String, ModelVersion> modelVersionCache = new HashMap<String, ModelVersion>();
	private HashMap<String, ModelConfiguration> modelConfigurationCache = new HashMap<String, ModelConfiguration>();
	private HashMap<String, SoftwareFunction> softwareFunctionCache = new HashMap<String, SoftwareFunction>();
	private HashMap<String, List<MetadataEnumeration>> enumCache = new HashMap<String, List<MetadataEnumeration>>();

	private ArrayList<Callback<Vocabulary, Throwable>> vocabulary_callbacks = new ArrayList<Callback<Vocabulary, Throwable>>();
	private ArrayList<Callback<List<SoftwareSummary>, Throwable>> list_callbacks = new ArrayList<Callback<List<SoftwareSummary>, Throwable>>();
	private ArrayList<Callback<List<SoftwareSummary>, Throwable>> list_models_callbacks = new ArrayList<Callback<List<SoftwareSummary>, Throwable>>();
	private ArrayList<Callback<List<SoftwareVersionSummary>, Throwable>> list_version_callbacks = new ArrayList<Callback<List<SoftwareVersionSummary>, Throwable>>();
	private ArrayList<Callback<List<SoftwareVersionSummary>, Throwable>> list_modelversion_callbacks = new ArrayList<Callback<List<SoftwareVersionSummary>, Throwable>>();
	private ArrayList<Callback<List<ModelConfigurationSummary>, Throwable>> list_modelconfigurations_callbacks = new ArrayList<Callback<List<ModelConfigurationSummary>, Throwable>>();
	private ArrayList<Callback<List<FunctionSummary>, Throwable>> list_function_callbacks = new ArrayList<Callback<List<FunctionSummary>, Throwable>>();
	private ArrayList<Callback<Boolean, Throwable>> perm_callbacks = new ArrayList<Callback<Boolean, Throwable>>();

	private HashMap<String, ArrayList<Callback<List<MetadataEnumeration>, Throwable>>> enum_callbacks = new HashMap<String, ArrayList<Callback<List<MetadataEnumeration>, Throwable>>>();
	...
	public SoftwareREST(String url) {
		...
		((RestServiceProxy) this.service).setResource(new Resource(url));
	}
	...
	public void getVocabulary(final Callback<Vocabulary, Throwable> callback, boolean reload) {
	...
	public void getModelsList(final Callback<List<SoftwareSummary>, Throwable> callback, boolean reload) {
	...
	public void getSoftwareList(final Callback<List<SoftwareSummary>, Throwable> callback, boolean reload) {
	...
	public void getSoftwareVersionList(String software,
			final Callback<List<SoftwareVersionSummary>, Throwable> callback, boolean reload) {
	...
	public void getModelVersionList(String model, final Callback<List<SoftwareVersionSummary>, Throwable> callback,
			boolean reload) {
			...
			if (list_modelversion_callbacks.isEmpty()) {
				...
				REST.withCallback(new MethodCallback<List<SoftwareVersionSummary>>() {
					...
					public void onSuccess(Method method, List<SoftwareVersionSummary> swlist) {
						...
						for (Callback<List<SoftwareVersionSummary>, Throwable> cb : list_modelversion_callbacks)
				...
				}).call(this.service).listModelVersions(model);
			} else {
				list_modelversion_callbacks.add(callback);
			}
		}
	...
	public void getFunctionList(final Callback<List<FunctionSummary>, Throwable> callback, boolean reload) {
	...
	/**
	 * Get a list of SoftwareVersion faceted 
	 * @param facets
	 * @param software
	 * @param callback
	 * @param isModel Indicates if the Software is of type Model
	 */
	public void getSoftwareVersionListFaceted(List<EnumerationFacet> facets, String software,
			final Callback<List<SoftwareVersionSummary>, Throwable> callback, boolean isModel) {
		MethodCallback<List<SoftwareVersionSummary>> methodCallback = new MethodCallback<List<SoftwareVersionSummary>>() {
			@Override
			public void onSuccess(Method method, List<SoftwareVersionSummary> swlist) {
				callback.onSuccess(swlist);
			}
	...
	public void getSoftware(final String swname, final Callback<Software, Throwable> callback, final boolean reload) {
	...
	public void getSoftwareFunction(final String swname, final String vname, final String fname,
			final Callback<SoftwareFunction, Throwable> callback, final boolean reload) {
		// GWT.log(softwareCache.keySet().toString() + ": "+reload);
		if (softwareFunctionCache.containsKey(vname) && !reload) {
			...
			}).call(this.service).getSoftwareFunction(URL.encodeQueryString(swname), URL.encodeQueryString(vname),
					URL.encodeQueryString(fname));
		}
	}

	public void getModelRDF(final String modelid, final Callback<String, Throwable> callback) {
		...
		try {
			rb.sendRequest(null, new RequestCallback() {
				...
				public void onError(Request request, Throwable exception) {
					...
					callback.onFailure(new Throwable("Software graph could not be found"));
				}
			});
		} catch (Exception e) {
			AppNotification.notifyFailure("Could not find " + modelid);
	...
	public void getSoftwareRDF(final String swid, final Callback<String, Throwable> callback) {
	...
	public void getEnumerationsForType(final String typeid,
		...
		if (enumCache.containsKey(typeid)) {
			...
			ArrayList<Callback<List<MetadataEnumeration>, Throwable>> type_enum_callbacks = enum_callbacks.get(typeid);
			if (type_enum_callbacks == null) {
				type_enum_callbacks = new ArrayList<Callback<List<MetadataEnumeration>, Throwable>>();
			}
	 ...
	 *            Software to publish
	 * @param callback
	 *            Actions to be done after executing publishing
	 * @param isModel
	 *            Boolean value to indicate if software is of type model
	 */
	public void publishSoftware(final Software software, final Callback<Software, Throwable> callback,
			boolean isModel) {
	...
	public void deleteModel(final String modelName, final Callback<Void, Throwable> callback) {
		REST.withCallback(new MethodCallback<Void>() {
			@Override
			public void onSuccess(Method method, Void v) {
	...
	public void deleteModelVersion(final String swname, final String vname, final Callback<Void, Throwable> callback) {
		REST.withCallback(new MethodCallback<Void>() {
			@Override
			public void onSuccess(Method method, Void v) {
	...
	public void runPlugin(final String pluginname, final Software software,
		...
		REST.withCallback(new MethodCallback<PluginResponse>() {
			...
			public void onSuccess(Method method, PluginResponse response) {
				String msg = pluginname + " Plugin: " + "Got a response for " + response.getSoftwareInfo().getLabel();
	...
	public void getPermissionTypes(final Callback<List<String>, Throwable> callback) {
	...
	public void getSoftwarePermissions(String name, final Callback<Permission, Throwable> callback) {
	...
	public void addSoftwareOwner(String swname, String username, final Callback<Boolean, Throwable> callback) {
		REST.withCallback(new MethodCallback<Boolean>() {
			@Override
			public void onSuccess(Method method, Boolean success) {
				callback.onSuccess(success);
	...
	public void removeSoftwareOwner(String swname, String username, final Callback<Boolean, Throwable> callback) {
		REST.withCallback(new MethodCallback<Boolean>() {
			@Override
			public void onSuccess(Method method, Boolean success) {
				callback.onSuccess(success);
