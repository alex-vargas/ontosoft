...
public class Config {
	...
	private PropertyListConfiguration loadServerConfiguration(HttpServletRequest request) {
		...
		if (configFile == null) {
			...
			if (home != null && !home.equals(""))
				configFile = home + File.separator + ".ontosoft" + File.separator + "server.properties";
			else
	...
	private void createDefaultServerConfig(HttpServletRequest request, String configFile) {
		...
		if (home != null && !home.equals(""))
			...
			storageDir = System.getProperty("java.io.tmpdir") + File.separator + "ontosoft" + File.separator
					+ "storage";
