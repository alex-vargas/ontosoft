...
public class PublishModelPresenter extends
    Presenter<PublishModelPresenter.MyView, PublishModelPresenter.MyProxy> {
  ...
  @Inject
  public PublishModelPresenter(EventBus eventBus, MyView view, final MyProxy proxy,
