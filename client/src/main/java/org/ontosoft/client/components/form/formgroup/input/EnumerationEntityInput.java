...
public class EnumerationEntityInput implements IEntityInput {
	...
	public void createWidget(Entity e, final MetadataProperty prop, Vocabulary vocabulary) {
		...
		this.api.getEnumerationsForType(type.getId(), new Callback<List<MetadataEnumeration>, Throwable>() {
			@Override
		...
		myinput.setPlaceholder(prop.getLabel() + (type.getLabel() != null ? " (" + type.getLabel() + ")" : ""));
