...
public class CommunityView extends ParameterizedViewImpl implements CommunityPresenter.MyView {
	...
	private ListDataProvider<MetadataEnumeration> listProvider = new ListDataProvider<MetadataEnumeration>();
	...
	private void initTable() {
		ListHandler<MetadataEnumeration> sortHandler = new ListHandler<MetadataEnumeration>(listProvider.getList());
		...
		// Name Column
		TextColumn<MetadataEnumeration> namecol = new TextColumn<MetadataEnumeration>() {
			@Override
