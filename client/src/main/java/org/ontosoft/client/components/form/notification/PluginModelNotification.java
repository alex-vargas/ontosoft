...
public class PluginModelNotification extends Panel {
	PluginResponse response;
	String target;
	String parentid;
	ModelForm form;

	public PluginModelNotification(PluginResponse response, String parentid, ModelForm form) {
	...
	private PanelHeader getPanelHeader() {
		final PluginModelNotification me = this;
