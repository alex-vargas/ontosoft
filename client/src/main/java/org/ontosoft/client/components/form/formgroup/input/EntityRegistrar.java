...
public class EntityRegistrar {
	...
	public static IEntityInput getInput(Entity entity, MetadataProperty mprop, Vocabulary vocabulary) throws Exception {
		String inputClass = inputClasses.get(mprop.getRange());
		if (mprop.getId() == KBConstants.ONTNS() + "affectsSoftwareFunction"
				|| mprop.getId() == KBConstants.ONTNS() + "fixedKnownIssue") {
	...
	public static Entity getEntity(String id, Object value, String type) throws Exception {
	...
	public static IEntityInput getInput(Entity entity, MetadataProperty mprop, Vocabulary vocabulary,
			SoftwareVersion version) throws Exception {
		String inputClass = inputClasses.get(mprop.getRange());
		if (inputClass != null) {
			Object item = entityFactory.instantiate(inputClass);
			if (item == null) {
