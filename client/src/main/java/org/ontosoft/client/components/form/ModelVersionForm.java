...
public class ModelVersionForm extends Composite 
implements HasModelVersionHandlers, HasPluginHandlers {
  ...
  @Override
  public HandlerRegistration addModelVersionSaveHandler(
      ModelVersionSaveHandler handler) {
    return handlerManager.addHandler(ModelVersionSaveEvent.TYPE, handler);
  }
  
  @Override
  public HandlerRegistration addModelVersionChangeHandler(
      ModelVersionChangeHandler handler) {
