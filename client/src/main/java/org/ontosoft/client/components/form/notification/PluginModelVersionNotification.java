...
public class PluginModelVersionNotification extends Panel {
	PluginResponse response;
	String target;
	String parentid;
	ModelVersionForm form;

	public PluginModelVersionNotification(PluginResponse response, String parentid, ModelVersionForm form) {
	...
	private PanelHeader getPanelHeader() {
		final PluginModelVersionNotification me = this;
