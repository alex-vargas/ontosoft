...
public class EnumerationEntityAdapter extends EntityAdapter {
	...
	public boolean saveEntity(Entity entity) {
		if (entity.getLabel().equals("") || entity.getLabel() == null) {
			return false;
		}
		...
		if (entityobj == null) {
			...
			for (MetadataEnumeration menum : repo.getEnumerationsForType(entity.getType())) {
		...
		if (entityobj == null || (entityobj != null && entity.getLabel() != this.enumkb.getLabel(entityobj))) {
