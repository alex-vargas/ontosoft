...
public class GithubPlugin extends Plugin {
	...
	public GithubPlugin() {
		super("Github", "Get github metadata", KBConstants.ONTNS() + "hasCodeLocation");
	...
	private void addRepositoryMetadata(String userid, String repoid, PluginResponse response) {
		String ontns = KBConstants.ONTNS();
	...
	private void addDocumentationMetadata(String userid, String repoid, PluginResponse response) {
		String ontns = KBConstants.ONTNS();
