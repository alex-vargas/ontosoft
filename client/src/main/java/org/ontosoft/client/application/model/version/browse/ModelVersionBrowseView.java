...
public class ModelVersionBrowseView extends ParameterizedViewImpl implements ModelVersionBrowsePresenter.MyView {
	...
	private void initModel(String modelName) {
		...
		// softwareLink = "<a href='" + softwareLink + "'>" + model.getSoftwareName() +
		// "</a>";
		// else
	...
	void onEditButtonClick(ClickEvent event) {
		...
		History.newItem(NameTokens.publishModelVersion + "/" + swnames[0] + ":" + version.getName());
	}
	...
	void onHTMLButtonClick(ClickEvent event) {
		...
		String styles = "<style>\n" + "* { font-family: Arial, Helvetica }" + ".browse-label {\n"
		...
		String html = "<html><head>" + styles + "</head><body>" + modelHTML + "</body></html>";
...
//
//					// Go to the new item
//					History.newItem(NameTokens.publishModelVersion + "/" + swnames[0] + ":" + sw.getName());
//
//					publishdialog.hide();
//					modellabel.setValue(null);
//				}
