...
public class UserREST {
	...
	public static void login(UserCredentials credentials, final Callback<UserSession, Throwable> callback) {
	...
	public static void validateSession(UserSession session, final Callback<UserSession, Throwable> callback) {
		REST.withCallback(new MethodCallback<UserSession>() {
			@Override
			public void onFailure(Method method, Throwable exception) {
				callback.onFailure(exception);
	...
	public static void addUser(UserCredentials user, final Callback<UserCredentials, Throwable> callback) {
	...
	public static void deleteUser(String username, final Callback<Void, Throwable> callback) {
		REST.withCallback(new MethodCallback<Void>() {
			@Override
			public void onFailure(Method method, Throwable exception) {
				callback.onFailure(exception);
	...
	public static void getUser(String username, final Callback<UserCredentials, Throwable> callback) {
		REST.withCallback(new MethodCallback<UserCredentials>() {
			@Override
			public void onFailure(Method method, Throwable exception) {
				callback.onFailure(exception);
	...
	public static void userExists(String username, final Callback<Boolean, Throwable> callback) {
