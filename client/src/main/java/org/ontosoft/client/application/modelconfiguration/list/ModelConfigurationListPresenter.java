...
public class ModelConfigurationListPresenter extends
    Presenter<ModelConfigurationListPresenter.MyView,
    ModelConfigurationListPresenter.MyProxy> {
  ...
  @Inject
  public ModelConfigurationListPresenter(EventBus eventBus, MyView view,
		  MyProxy proxy) {
